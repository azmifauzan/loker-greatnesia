...
<div class="row">					
	...
	<div class="widget">
		...
		<div class="widget-content">
		    <?php echo form_open('admin/channel/tambahp','class="form-horizontal"'); ?>
		    <fieldset>			    
			<div class="control-group">											
			    <label class="control-label" for="nama">Nama Channel</label>
			    <div class="controls">
				    <input type="text" class="input-medium span4" name="nama" value="<?php echo set_value('nama'); ?>" />
			...
			<div class="control-group">											
			    ...
			    <div class="controls">
				    <textarea name="deskripsi" class="span4"><?php echo set_value('deskripsi'); ?></textarea>
			...
			<div class="control-group">											
			    ...
			    <div class="controls">
				    <input type="text" class="input-medium span4" name="web" value="<?php echo set_value('web'); ?>" placeholder="http://" />
